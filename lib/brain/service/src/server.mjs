...
// devuelven 501 (no 200 "vacío") -- nunca fail-open.
...
import { generate, AnthropicNotConfiguredError } from "./anthropic.mjs";
...
async function handlePublicChat(req, res, body) {
  ...
  return sendJson(res, 200, { answer: answerWithSources, sources, outOfCorpus: false, flaggedInjection: false });
}
